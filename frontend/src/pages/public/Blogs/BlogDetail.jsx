  ...
  if (isLoading) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#F9F9F9" }}>
        <p style={{ color: "#6B7280", fontFamily: "'Inter', sans-serif" }}>Loading blog...</p>
      </div>
    );
  }
          ...
          >
            ...
            {blog.author && (
              <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "3rem", paddingBottom: "2rem", borderBottom: "1px solid #F3F4F6" }}>
                ...
                <div>
                  <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", fontWeight: 600, color: "#111111" }}>{blog.author}</div>
                  <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "12px", color: "#6B7280" }}>Community Member</div>
                </div>
              </div>
            )}
          </motion.div>
