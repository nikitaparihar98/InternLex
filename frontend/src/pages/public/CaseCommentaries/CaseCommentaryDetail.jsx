  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        console.error("Failed to load case commentary", error);
      } finally {
        setIsLoading(false);
      }
    }
  ...
  if (isLoading) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#F9F9F9" }}>
        <p style={{ color: "#6B7280", fontFamily: "'Inter', sans-serif" }}>Loading case commentary...</p>
      </div>
    );
  }
  ...
  if (!commentary) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor: "#F9F9F9" }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "2rem", marginBottom: "1rem" }}>Case Commentary Not Found</h2>
        <Link to="/case-commentaries" style={{ color: "#B8871B", fontFamily: "'Inter', sans-serif", textDecoration: "none" }}>← Back to Case Commentaries</Link>
      </div>
    );
  }
    ...
    <>
      <main style={{ minHeight: "100vh", backgroundColor: "#FFFFFF", paddingTop: "120px", paddingBottom: "80px" }}>
        <article style={{ maxWidth: "800px", margin: "0 auto", padding: "0 clamp(1rem, 4vw, 2.5rem)" }}>
          ...
          >
            <Link to="/case-commentaries" style={{ display: "inline-block", color: "#6B7280", fontFamily: "'Inter', sans-serif", fontSize: "14px", textDecoration: "none", marginBottom: "2rem", transition: "color 0.2s" }} onMouseEnter={(e) => e.target.style.color = "#111111"} onMouseLeave={(e) => e.target.style.color = "#6B7280"}>
              ← Back to all case commentaries
            </Link>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "1.2rem", color: "#6B7280", marginBottom: "1.5rem" }}>
              {commentary.court}
            </p>
            ...
            {commentary.author && (
              <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "3rem", paddingBottom: "2rem", borderBottom: "1px solid #F3F4F6" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "#EDE7DC", display: "flex", justifyContent: "center", alignItems: "center", color: "#8A650F", fontWeight: 600, fontFamily: "'Inter', sans-serif" }}>
                  {commentary.author.charAt(0).toUpperCase()}
                </div>
                <div>
                  <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", fontWeight: 600, color: "#111111" }}>{commentary.author}</div>
...
export default CaseCommentaryDetail;
